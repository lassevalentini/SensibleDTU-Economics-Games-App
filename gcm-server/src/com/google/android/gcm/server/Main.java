...
public class Main {
    public static void main(String[] args) {
        ...
        sender = new Sender("AIzaSyDt66UAtAQ4DowgMSJ3ZaH3-XI1VaF7msk");
        b = new Message.Builder();
        b.addData("title", "You've won a code!");
        b.addData("timestamp", ""+(System.currentTimeMillis()/1000));
        b.addData("body", "Click to see");
        b.addData("type", "economics-game-finished");

        b.addData("code", UUID.randomUUID().toString());
//        b.addData("game-id", "321");
//        b.addData("game-type", "game-pgg");
//        b.addData("game-started", "timestamp");
//        b.addData("game-participants", "4");
